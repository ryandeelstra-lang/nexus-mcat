...
{ "fc": "FC1",
  "cards": [
    { "id": "BB.1A.amino-acids.general-structure.alpha-carbon.c1", "parent": "BB.1A.amino-acids.general-structure.alpha-carbon", "leaf": "BB.1A", "label": "What four groups bond to an amino acid's alpha-carbon?" },
    { "id": "BB.1A.amino-acids.general-structure.alpha-carbon.c2", "parent": "BB.1A.amino-acids.general-structure.alpha-carbon", "leaf": "BB.1A", "label": "Why is glycine's alpha-carbon not a stereocenter?" }
  ] }
```

...
"""charged_up: assemble the additive topic layer from parallel-agent YAML fragments.
...
def main() -> None:
    ...
    header = (
        ...
        "# The additive topic layer: every AAMC-outline topic/subtopic + the verified\n"

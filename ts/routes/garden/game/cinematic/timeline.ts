...
export const BACKDROPS: readonly BackdropCue[] = [
    {
        ...
        fadeInFrom: 0, fadeInTo: 0, fadeOutFrom: 7.4, fadeOutTo: 8.4,
        scaleFrom: 1.34, scaleTo: 1.46, driftX: -0.03, driftY: -0.02,
    },
    {
        key: "bg-versailles-establishing",
        fadeInFrom: 15.6, fadeInTo: 16.5, fadeOutFrom: 19.4, fadeOutTo: 20.2,
        scaleFrom: 1.32, scaleTo: 1.42, driftX: 0.028, driftY: -0.018,
    },
    {
        key: "bg-gardens-by-the-bay-establishing",
        fadeInFrom: 19.4, fadeInTo: 20.2, fadeOutFrom: 23.2, fadeOutTo: 24.4,
        scaleFrom: 1.42, scaleTo: 1.32, driftX: -0.024, driftY: 0.02,
    },
] as const;
